...
import { Mesh, gfx, utils, ModelComponent, Vec3 } from "cc";
...
export default class FixedModelMesh {
  static create(
    ...
    modelCount: number,
    attributes: AttributesKey[] = ["position", "normal", "tangent", "uv", "uv1"]
  ) {
    ...
    fixedModelMesh._iView = new Uint16Array(
      arrayBuffer,
      totalVerticesBytes,
      modelCount * indicesCount
    );
