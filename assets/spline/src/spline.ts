import { Component, Node, _decorator, Vec3, find, Vec2, warn, v3 } from 'cc';
...
export default class Spline extends Component {
    ...
    @type(SplineNode)
    public get splineNodes () : SplineNode[] {
        return this._nodes;//.map(node => SplineNode.create(node));
    }
    public set splineNodes (value: SplineNode[]) {
        this._nodes =value;
    }
    ...
    private _updateNodes () {
        ...
        if (!nodeRoot) {
            ...
            if (this._nodes.length) {
                ...
                this.addNode(v3(-5, 0, 0), v3(-5, 0, -3));
                this.addNode(v3(5, 0, 0), v3(5, 0, 3));
            }
    ...
    private startNode: SplineNode = null!;
    private endNode: SplineNode= null!;
