import { Vec3, Vec2, Quat,  v3 } from 'cc';
...
export default class CurveSample {
    ...
    public distanceInCurve: number= 0;
    public timeInCurve: number= 0;

    private _transformedUp: Vec3 = null!;
    get transformedUp () {
    ...
    private _bentRotation: Quat = null!;
    get bentRotation () {
