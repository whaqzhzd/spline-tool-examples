import { _decorator, Component, director, game, Node, ScrollViewComponent, Vec3, LayoutComponent, Vec2 } from 'cc';
...
export class BackButton extends Component {
    ...
    public backToList () {
        ...
        director.loadScene('testlist', function (this:BackButton) {
            ...
            if (BackButton._scrollNode) {
                ...
                BackButton._scrollCom!.scrollToOffset(BackButton.offset as unknown as Vec2, 0.1, true);
            }
            BackButton._blockInput.active = false;
        }.bind(this));
    }
